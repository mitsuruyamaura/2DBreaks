...
public class DragThumnail : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler {
    ...
    private DropMovieArea currentDropMovieArea;
    public DropMovieArea CurrentDropMovieArea {  // プロパティ。currentDropCharaArea が null のときには再取得する
        get {
            if (currentDropMovieArea == null && originalParent != null) {
                originalParent.TryGetComponent(out currentDropMovieArea);
            }
            return currentDropMovieArea;
        }
    }
    ...
    public void SetupDragThumnail(Canvas parentCanvas, int index) {
    ...
    public void OnBeginDrag(PointerEventData eventData) {
        ...
        currentDropMovieArea?.ReleaseThumnail();
        currentDropMovieArea = null;
    ...
    public void ReturnDropArea() {
        ...
        if (originalParent.TryGetComponent(out currentDropMovieArea)) {
            // 元のスロットに戻す
            currentDropMovieArea.SetChara(this);
        }
    }

    public void SetCurrentDropMovieArea(DropMovieArea dropCharaArea) {
        currentDropMovieArea = dropCharaArea;
